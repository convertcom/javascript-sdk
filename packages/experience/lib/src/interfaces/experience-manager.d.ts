 ...
 * License Apache-2.0
 */
import { Variation, Id, Experience, BucketedVariation } from '@convertcom/js-sdk-types';
...
export interface ExperienceManagerInterface {
    ...
    selectVariationById(visitorId: Id, experienceId: Id, visitorProperties: Record<string, any> | null, locationProperties: Record<string, any> | null, environment?: string): BucketedVariation | RuleError;
