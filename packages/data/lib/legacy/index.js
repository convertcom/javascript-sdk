...
var DataManager = /** @class */ (function () {
    ...
    function DataManager(config, _a) {
        ...
        (_f = (_e = this._loggerManager) === null || _e === void 0 ? void 0 : _e.trace) === null || _f === void 0 ? void 0 : _f.call(_e, enums.MESSAGES.DATA_CONSTRUCTOR, this);
    }
    ...
    DataManager.prototype._getBucketingByField = function (visitorId, identity, visitorProperties, locationProperties, identityField, environment) {
        ...
        if (experience && !isArchivedExperience && isEnvironmentMatch) {
            ...
            if (experience === null || experience === void 0 ? void 0 : experience.locations) {
                ...
                var locations = this.getItemsByIds(experience === null || experience === void 0 ? void 0 : experience.locations, 'locations');
            ...
            if (!locationProperties || locationMatched) {
                ...
                if (!visitorProperties || matchedAudiences.length) {
                    ...
                    if ((experience === null || experience === void 0 ? void 0 : experience.variations) && ((_d = experience === null || experience === void 0 ? void 0 : experience.variations) === null || _d === void 0 ? void 0 : _d.length)) {
                        ...
                        (_f = (_e = this._loggerManager) === null || _e === void 0 ? void 0 : _e.debug) === null || _f === void 0 ? void 0 : _f.call(_e, enums.MESSAGES.VARIATIONS_NOT_FOUND, {
                            visitorProperties: visitorProperties,
                            audiences: audiences
                        });
                    }
                ...
                (_k = (_j = this._loggerManager) === null || _j === void 0 ? void 0 : _j.debug) === null || _k === void 0 ? void 0 : _k.call(_j, enums.MESSAGES.LOCATION_NOT_MATCH, (_a = {
                        locationProperties: locationProperties
                    },
    ...
    DataManager.prototype._retrieveBucketing = function (visitorId, experience) {
        ...
        if (variationId &&
            ...
            (_d = (_c = this._loggerManager) === null || _c === void 0 ? void 0 : _c.debug) === null || _d === void 0 ? void 0 : _d.call(_c, enums.MESSAGES.BUCKETED_VISITOR_FOUND, {
                storeKey: storeKey,
                visitorId: visitorId,
            ...
            if (variationId_1 &&
                ...
                // If it's found log debug info. The return value will be formed next step
                (_h = (_g = this._loggerManager) === null || _g === void 0 ? void 0 : _g.debug) === null || _h === void 0 ? void 0 : _h.call(_g, enums.MESSAGES.BUCKETED_VISITOR_FOUND, {
                    storeKey: storeKey,
                    visitorId: visitorId,
                ...
                if (variationId_1) {
                    ...
                    (_m = (_l = this._loggerManager) === null || _l === void 0 ? void 0 : _l.error) === null || _m === void 0 ? void 0 : _m.call(_l, enums.ERROR_MESSAGES.UNABLE_TO_SELECT_BUCKET_FOR_VISITOR, {
                        visitorId: visitorId,
    ...
    DataManager.prototype.convert = function (visitorId, goalId, goalRule, goalData, segments) {
        ...
        if (goalRule) {
            if (!(goal === null || goal === void 0 ? void 0 : goal.rules))
                return;
            var ruleMatched = this._ruleManager.isRuleMatched(goalRule, goal === null || goal === void 0 ? void 0 : goal.rules);
            // Return rule errors if present
