    ...
    _getBucketingByField(visitorId, identity, visitorProperties, locationProperties, identityField = 'key', environment = this._environment) {
        ...
        if (experience &&
            ...
            if (experience === null || experience === void 0 ? void 0 : experience.locations) {
                ...
                const matchedErrors = matchedLocations.filter((match) => Object.values(RuleError).includes(match));
            ...
            if (!locationProperties || locationMatched) {
                ...
                if (experience === null || experience === void 0 ? void 0 : experience.audiences) {
                    ...
                    // Return rule errors if present
                    const matchedErrors = matchedAudiences.filter((match) => Object.values(RuleError).includes(match));
                    if (matchedErrors.length)
                        return matchedErrors[0];
                }
