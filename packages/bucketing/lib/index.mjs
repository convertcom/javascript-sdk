...
class BucketingManager {
    ...
    constructor(config, { loggerManager } = {}) {
        ...
        this._max_traffic = objectDeepValue(config, 'bucketing.max_traffic', DEFAULT_MAX_TRAFFIC, true);
        this._hash_seed = objectDeepValue(config, 'bucketing.hash_seed', DEFAULT_HASH_SEED, true);
        (_b = (_a = this._loggerManager) === null || _a === void 0 ? void 0 : _a.trace) === null || _b === void 0 ? void 0 : _b.call(_a, MESSAGES.BUCKETING_CONSTRUCTOR, this);
    }
    /**
